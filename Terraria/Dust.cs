...
namespace Terraria
{
	public class Dust
	{
		...
		public Color GetAlpha(Color newColor)
		{
			...
			{
				result = new Color((int)newColor.R, (int)newColor.G, (int)newColor.B, 25);
			}
			else if ((this.type == 68 || this.type == 70) && this.noGravity)
			{
			...
			else
			{
				...
				else
				{
					if (this.type == 66)
					{
						result = new Color((int)newColor.R, (int)newColor.G, (int)newColor.B, 0);
						return result;
					}
					if (this.type == 71)
					{
					...
					if (this.type == 72)
					{
						result = new Color(200, 200, 200, 200);
						return result;
					}
				}
