...
namespace Terraria
{
	public class NetMessage
	{
		...
		public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, string text = "", int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0)
		{
			...
			lock (NetMessage.buffer[num])
			{
				...
				else if (msgType == 2)
				{
					...
					if (Main.dedServ)
					{
						Console.WriteLine(Netplay.serverSock[num].tcpClient.Client.RemoteEndPoint.ToString() + " 已被逐出: " + text);
					}
				}
				else if (msgType == 3)
				{
				...
				else if (msgType == 25)
				{
					...
					byte[] bytes116;
					if (text.Substring(0, 1) != "/" && (Convert.ToChar(text.Substring(0, 1)) >= '¡' || Convert.ToChar(text.Substring(text.Length - 1, 1)) >= '¡'))
					{
						byte[] bytes115 = Encoding.UTF8.GetBytes(text);
						bytes116 = Encoding.UTF8.GetBytes(Convert.ToBase64String(bytes115) + "[\"CHS\"]");
					}
					else
					{
						bytes116 = Encoding.UTF8.GetBytes(text);
					}
					byte b32 = (byte)number2;
					byte b33 = (byte)number3;
					byte b34 = (byte)number4;
					num2 += 1 + bytes116.Length + 3;
				...
				else if (msgType == 26)
				{
					...
					byte[] bytes119 = BitConverter.GetBytes((short)number3);
					byte[] bytes120 = Encoding.UTF8.GetBytes(text);
					byte b37 = (byte)number4;
					byte b38 = (byte)number5;
					num2 += 2 + bytes119.Length + 1 + bytes120.Length + 1;
					byte[] bytes121 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes121, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
				...
				else if (msgType == 27)
				{
					...
					byte[] bytes123 = BitConverter.GetBytes((short)Main.projectile[number].identity);
					byte[] bytes124 = BitConverter.GetBytes(Main.projectile[number].position.X);
					byte[] bytes125 = BitConverter.GetBytes(Main.projectile[number].position.Y);
					byte[] bytes126 = BitConverter.GetBytes(Main.projectile[number].velocity.X);
					byte[] bytes127 = BitConverter.GetBytes(Main.projectile[number].velocity.Y);
					byte[] bytes128 = BitConverter.GetBytes(Main.projectile[number].knockBack);
					byte[] bytes129 = BitConverter.GetBytes((short)Main.projectile[number].damage);
					Buffer.BlockCopy(bytes122, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
					...
					{
						byte[] bytes130 = BitConverter.GetBytes(Main.projectile[number].ai[m]);
						Buffer.BlockCopy(bytes130, 0, NetMessage.buffer[num].writeBuffer, num3, bytes130.Length);
						num3 += 4;
					}
					num2 += num3;
					byte[] bytes131 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes131, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
				}
				else if (msgType == 28)
				{
					byte[] bytes132 = BitConverter.GetBytes(msgType);
					byte[] bytes133 = BitConverter.GetBytes((short)number);
					byte[] bytes134 = BitConverter.GetBytes((short)number2);
					byte[] bytes135 = BitConverter.GetBytes(number3);
					byte b39 = (byte)(number4 + 1f);
					byte b40 = (byte)number5;
					num2 += bytes133.Length + bytes134.Length + bytes135.Length + 1 + 1;
					byte[] bytes136 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes136, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes132, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
				...
				else if (msgType == 29)
				{
					...
					byte[] bytes138 = BitConverter.GetBytes((short)number);
					byte b41 = (byte)number2;
					num2 += bytes138.Length + 1;
				...
				else if (msgType == 30)
				{
					...
					num2 += 2;
					byte[] bytes141 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes141, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
				...
				{
					byte[] bytes142 = BitConverter.GetBytes(msgType);
					byte[] bytes143 = BitConverter.GetBytes(number);
					byte[] bytes144 = BitConverter.GetBytes((int)number2);
					num2 += bytes143.Length + bytes144.Length;
					byte[] bytes145 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes145, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes142, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
				...
				else if (msgType == 32)
				{
					...
					{
						bytes148 = BitConverter.GetBytes(0);
					}
					else
					{
						bytes148 = BitConverter.GetBytes((short)Main.chest[number].item[(int)number2].netID);
					}
					num2 += bytes147.Length + 1 + 1 + 1 + bytes148.Length;
				...
				else if (msgType == 33)
				{
					...
					if (number > -1)
					{
						bytes152 = BitConverter.GetBytes(Main.chest[number].x);
						bytes153 = BitConverter.GetBytes(Main.chest[number].y);
					}
					else
					{
					...
					num2 += bytes151.Length + bytes152.Length + bytes153.Length;
				...
				else if (msgType == 34)
				{
					...
					byte[] bytes156 = BitConverter.GetBytes(number);
					byte[] bytes157 = BitConverter.GetBytes((int)number2);
					num2 += bytes156.Length + bytes157.Length;
				...
				else if (msgType == 35)
				{
					...
					byte[] bytes160 = BitConverter.GetBytes((short)number2);
					num2 += 1 + bytes160.Length;
					...
					num3++;
					Buffer.BlockCopy(bytes160, 0, NetMessage.buffer[num].writeBuffer, num3, 2);
				}
				else if (msgType == 36)
				{
				...
				else if (msgType == 38)
				{
					...
					byte[] bytes167 = Encoding.UTF8.GetBytes(text);
				...
				else if (msgType == 39)
				{
					...
					byte[] bytes170 = BitConverter.GetBytes((short)number);
					num2 += bytes170.Length;
				...
				else if (msgType == 40)
				{
					...
					byte[] bytes173 = BitConverter.GetBytes((short)Main.player[(int)b53].talkNPC);
					num2 += 1 + bytes173.Length;
					byte[] bytes174 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes174, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
				...
				{
					byte[] bytes175 = BitConverter.GetBytes(msgType);
					byte b54 = (byte)number;
					byte[] bytes176 = BitConverter.GetBytes(Main.player[(int)b54].itemRotation);
					byte[] bytes177 = BitConverter.GetBytes((short)Main.player[(int)b54].itemAnimation);
					num2 += 1 + bytes176.Length + bytes177.Length;
					byte[] bytes178 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes178, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes175, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
				...
				else if (msgType == 42)
				{
					...
					byte[] bytes180 = BitConverter.GetBytes((short)Main.player[(int)b55].statMana);
					byte[] bytes181 = BitConverter.GetBytes((short)Main.player[(int)b55].statManaMax);
					num2 += 1 + bytes180.Length + bytes181.Length;
				...
				else if (msgType == 43)
				{
					...
					byte[] bytes184 = BitConverter.GetBytes((short)number2);
					num2 += 1 + bytes184.Length;
					...
					num3++;
					Buffer.BlockCopy(bytes184, 0, NetMessage.buffer[num].writeBuffer, num3, 2);
				}
				else if (msgType == 44)
				{
					...
					byte[] bytes187 = BitConverter.GetBytes((short)number3);
					byte b59 = (byte)number4;
					byte[] bytes188 = Encoding.UTF8.GetBytes(text);
					num2 += 2 + bytes187.Length + 1 + bytes188.Length;
					...
					num3++;
					Buffer.BlockCopy(bytes188, 0, NetMessage.buffer[num].writeBuffer, num3, bytes188.Length);
					num3 += bytes188.Length;
				}
				else if (msgType == 45)
				{
				...
				else if (msgType == 46)
				{
					...
					byte[] bytes193 = BitConverter.GetBytes(number);
					byte[] bytes194 = BitConverter.GetBytes((int)number2);
					num2 += bytes193.Length + bytes194.Length;
				...
				else if (msgType == 47)
				{
					...
					byte[] bytes198 = BitConverter.GetBytes(Main.sign[number].x);
					byte[] bytes199 = BitConverter.GetBytes(Main.sign[number].y);
					byte[] bytes200 = Encoding.UTF8.GetBytes(Main.sign[number].text);
					num2 += bytes197.Length + bytes198.Length + bytes199.Length + bytes200.Length;
				...
				else if (msgType == 48)
				{
					...
					num2 += bytes203.Length + bytes204.Length + 1 + 1;
					...
					num3 += 4;
					Buffer.BlockCopy(bytes204, 0, NetMessage.buffer[num].writeBuffer, num3, 4);
					num3 += 4;
				...
				else if (msgType == 52)
				{
					...
					byte[] bytes213 = BitConverter.GetBytes((int)number3);
					byte[] bytes214 = BitConverter.GetBytes((int)number4);
					num2 += 2 + bytes213.Length + bytes214.Length;
				...
				else if (msgType == 53)
				{
					...
					byte[] bytes217 = BitConverter.GetBytes((short)number);
					byte b68 = (byte)number2;
					byte[] bytes218 = BitConverter.GetBytes((short)number3);
					num2 += bytes217.Length + 1 + bytes218.Length;
					...
					num3++;
					Buffer.BlockCopy(bytes218, 0, NetMessage.buffer[num].writeBuffer, num3, bytes218.Length);
					num3 += bytes218.Length;
				}
				else if (msgType == 54)
				{
					byte[] bytes220 = BitConverter.GetBytes(msgType);
					byte[] bytes221 = BitConverter.GetBytes((short)number);
					num2 += bytes221.Length + 15;
					...
					for (int num11 = 0; num11 < 5; num11++)
					{
						...
						num3++;
						byte[] bytes223 = BitConverter.GetBytes(Main.npc[(int)((short)number)].buffTime[num11]);
				...
				else if (msgType == 56)
				{
					...
					byte[] bytes229 = Encoding.UTF8.GetBytes(Main.chrName[number]);
					num2 += bytes228.Length + bytes229.Length;
					byte[] bytes230 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes230, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					...
					Buffer.BlockCopy(bytes229, 0, NetMessage.buffer[num].writeBuffer, num3, bytes229.Length);
				}
				else if (msgType == 57)
				{
				...
				{
					byte[] bytes233 = BitConverter.GetBytes(msgType);
					byte b71 = (byte)number;
					byte[] bytes234 = BitConverter.GetBytes(number2);
					num2 += 1 + bytes234.Length;
					byte[] bytes235 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes235, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes233, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
					NetMessage.buffer[num].writeBuffer[num3] = b71;
					num3++;
					Buffer.BlockCopy(bytes234, 0, NetMessage.buffer[num].writeBuffer, num3, bytes234.Length);
				}
				else if (msgType == 59)
				{
					byte[] bytes236 = BitConverter.GetBytes(msgType);
					byte[] bytes237 = BitConverter.GetBytes(number);
					byte[] bytes238 = BitConverter.GetBytes((int)number2);
					num2 += bytes237.Length + bytes238.Length;
					byte[] bytes239 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes239, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes236, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
				...
				{
					byte[] bytes240 = BitConverter.GetBytes(msgType);
					byte[] bytes241 = BitConverter.GetBytes((short)number);
					byte[] bytes242 = BitConverter.GetBytes((short)number2);
					byte[] bytes243 = BitConverter.GetBytes((short)number3);
					byte b72 = (byte)number4;
					num2 += bytes241.Length + bytes242.Length + bytes243.Length + 1;
					byte[] bytes244 = BitConverter.GetBytes(num2 - 4);
					Buffer.BlockCopy(bytes244, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
					Buffer.BlockCopy(bytes240, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
				...
				else if (Netplay.clientSock.tcpClient.Connected)
				{
					try
					{
				...
				if (Main.verboseNetplay)
				{
					...
					{
						byte b73 = NetMessage.buffer[num].writeBuffer[num18];
					}
				}
		...
		public static void greetPlayer(int plr)
		{
			if (Main.motd == "")
			{
				NetMessage.SendData(25, plr, -1, "欢迎来到 " + Main.worldName + "!", 255, 255f, 240f, 20f, 0);
			}
			else
			{
			...
			NetMessage.SendData(25, plr, -1, "当前玩家: " + text + ".", 255, 255f, 240f, 20f, 0);
		}
			...
			for (int i = 0; i < 255; i++)
			{
				...
				if (Netplay.serverSock[i].state == 10)
				{
					...
					if (!Netplay.serverSock[i].announced)
					{
						...
						NetMessage.SendData(25, -1, i, Main.player[i].name + " 已经加入", 255, 255f, 240f, 20f, 0);
						if (Main.dedServ)
						{
							Console.WriteLine(Main.player[i].name + " 已经加入");
						}
					}
				}
				else
				{
					...
					if (Netplay.serverSock[i].announced)
					{
						...
						NetMessage.SendData(25, -1, i, Netplay.serverSock[i].oldName + " 已经退出", 255, 255f, 240f, 20f, 0);
						if (Main.dedServ)
						{
							Console.WriteLine(Netplay.serverSock[i].oldName + " 已经退出");
						}
					}
				}
			}
