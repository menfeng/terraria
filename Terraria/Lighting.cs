	...
	public class Lighting
	{
			...
			if (Main.renderCount > Lighting.maxRenderCount)
			{
				...
				for (int num37 = num17; num37 < num18; num37++)
				{
					for (int num38 = num19; num38 < num20; num38++)
					{
							...
							if (num37 > num17 + num41 && num37 < num18 - num41 && num38 > num19 + num42 && num38 < num20 - num42)
							{
								...
								else
								{
									...
									default:
										...
										else if (Main.tile[num37, num38].frameX >= 36)
										{
											int num43 = 0;
						...
						else if (Lighting.color2[num39, num40] > 0f)
						{
							if (Lighting.minX > num39)
							{
								Lighting.minX = num39;
		...
		private static void LightColor(int i, int j)
		{
			...
			if (Lighting.color2[num + Lighting.dirX, num2 + Lighting.dirY] <= Lighting.lightColor)
			{
				...
				else if (Lighting.wetLight[num, num2])
				{
		...
		public static int LightingX(int lightX)
		{
			...
			else if (lightX >= Main.screenWidth / 16 + Lighting.offScreenTiles * 2 + 10)
			{
				result = Main.screenWidth / 16 + Lighting.offScreenTiles * 2 + 10 - 1;
			}
			else
			{
				result = lightX;
		...
		public static int LightingY(int lightY)
		{
			...
			else if (lightY >= Main.screenHeight / 16 + Lighting.offScreenTiles * 2 + 10)
			{
				result = Main.screenHeight / 16 + Lighting.offScreenTiles * 2 + 10 - 1;
			}
			else
			{
				result = lightY;
		...
		public static Color GetColor(int x, int y, Color oldColor)
		{
			...
			else if (num < 0 || num2 < 0 || num >= Main.screenWidth / 16 + Lighting.offScreenTiles * 2 + 10 || num2 >= Main.screenHeight / 16 + Lighting.offScreenTiles * 2 + 10)
			{
				result = Color.Black;
			}
			else
		...
		public static Color GetColor(int x, int y)
		{
			...
			else
			{
				...
				Color color = new Color((int)((byte)num3), (int)((byte)num4), (int)((byte)num5), 255);
				result = color;
			}
			return result;
		}
		...
		public static Color GetBlackness(int x, int y)
		{
			...
			{
				Color color = new Color(0, 0, 0, (int)((byte)(255f - 255f * Lighting.color[num, num2])));
				result = color;
			}
			return result;
		}
		...
		public static float Brightness(int x, int y)
		{
			...
			{
				result = (Lighting.color[num, num2] + Lighting.colorG[num, num2] + Lighting.colorB[num, num2]) / 3f;
			}
			return result;
		}
		...
		public static bool Brighter(int x, int y, int x2, int y2)
		{
			...
			try
			{
				result = (Lighting.color[num, num2] + Lighting.colorG[num, num2] + Lighting.colorB[num, num2] >= Lighting.color[num3, num4] + Lighting.colorG[num3, num4] + Lighting.colorB[num3, num4]);
			}
			catch
			{
				result = false;
